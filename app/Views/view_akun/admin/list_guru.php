...
<script>
    var list_siswa = $('#table_siswa').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url(); ?>/akun/admin/data_pegawai/gtk/get_all",
            dataSrc: "",
        },
        columns: [{
                data: null
            ...
            <?php if ($user_info["is_admin"] == 1) { ?>, {
                    data: function(row, type, set) {
                        if (row.perbaikan == 1) {
                            return ("<span class='shadow-none badge list_active'>YA</span>")
...
<script type="text/javascript">
    function lihat_modal_siswa(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url($request->uri->getSegment(1) . '/admin/data_pegawai/gtk/single_gtk'); ?>",
            data: dataJson,
