                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="table-responsive mb-4 mt-4">
                            <h6 style="text-align: center;">Tahun <i><?= $tahun_aktif; ?></i></h6>
                        ...
                        <div class="as-footer-container" style="text-align: right;">
                            <a class="btn btn-primary" href="<?= base_url() ?>/akun/app/rombel">Kembali</a>
                        </div>
...
<script>
    var list_siswa = $('#table_siswa').DataTable({
        ...
        ajax: {
            url: "<?php echo base_url(); ?>/akun/app/rombel/ambil_kelas/<?= $nama_kelas; ?>",
            dataSrc: "",
        },
...
<script type="text/javascript">
    function lihat_modal_siswa(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url($request->uri->getSegment(1) . '/app/siswa/single_siswa'); ?>",
