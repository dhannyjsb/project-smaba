                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="table_surat_keputusan" class="table table-bordered table-striped mb-4" style="width:100%">
                                <thead>
                                    <tr>
...
<!--  MODAL SINGLE VIEW  -->
<?php echo form_open_multipart(current_url(), 'class="form-horizontal" id="form_tambah_surat_keputusan"');  ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="format_tanggal" name="tanggal_surat_keputusan" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Isi Tanggal..">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" style="font-size: 0.85rem!important;" name="tahun_surat_keputusan" placeholder="PERIHAL SURAT" value="<?php echo date("Y"); ?>">
                    <input type="hidden" class="form-control" style="font-size: 0.85rem!important;" name="pembuat_surat_keputusan" value="<?= $user_info['id_unik']; ?>">
...
<div class="modal fade view_modal_data" id="view_modal_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" keyboard="false">
    <div class="modal-dialog" role="document" id="modal-edit">
        <div class="modal-content">
            ...
            <?php echo form_open(base_url('/akun/app/arsipsurat/simpan_edit_surat_keputusan'), 'class="form-horizontal" id="form_edit_surat_keputusan"');  ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" name="penghapus_surat_keputusan" class="form-control" style="font-size: 0.85rem!important;" id="penghapus_surat_keputusan" value="<?= $user_info['id_unik']; ?>">
...
<script>
    $(document).ready(function() {
        ...
        var list_surat_keputusan = $("#table_surat_keputusan").DataTable({
            ...
            ajax: {
                <?php if ($user_info['is_admin'] == 1) { ?> "url": "get_all_surat_keputusan_admin/<?php echo date('Y') ?>",
                <?php } else { ?> "url": "get_all_surat_keputusan/<?php echo date('Y') ?>",
                <?php } ?> "dataSrc": "",
            },
            columns: [{
                    orderable: true,
                    ...
                    data: function(row, type, set) {
                        if (<?= $user_info['is_admin']; ?> == 1) {
                            if (row.deleted_at == '0000-00-00 00:00:00') {
                                return (
                                    '<div class="btn-group">' +
                                    ' <button style="margin-right: 0px;" type="button" class="btn btn-dark btn-sm" onclick="modal_edit_surat_keputusan(' + row.surat_keputusan_id + ')" data-toggle="modal" data-target=".view_modal_data">Lihat</button>' +
