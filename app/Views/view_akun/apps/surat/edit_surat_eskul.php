...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type=" text" class="form-control" style="font-size: 0.85rem!important;" name="no_surat" placeholder="NO SURAT" value="<?= esc($data_surat['no_surat_eskul']); ?>" required>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label style="color: black;font-size: 0.85rem!important;">KODE SURAT</label>
            <input type="text" class="form-control" style="font-size: 0.85rem!important;" name="kode_surat" placeholder="KODE SURAT" value="<?= esc($data_surat['second_surat_eskul']); ?>" required>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" style="font-size: 0.85rem!important;" name="no_berkas" placeholder="NO BERKAS" value="<?= esc($data_surat['no_berkas_eskul']); ?>" required>
            <input type="hidden" class="form-control" style="font-size: 0.85rem!important;" name="surat_eskul_id" placeholder="NO BERKAS" value="<?= esc($data_surat['surat_eskul_id']); ?>" required>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input id="format_tanggal" value="<?= esc($data_surat['tanggal_surat_eskul']); ?>" name="tanggal_surat_eskul" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Isi Tanggal..">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" style="font-size: 0.85rem!important;" name="tujuan_surat" placeholder="ALAMAT TUJUAN" value="<?= esc($data_surat['alamat_surat_eskul']); ?>" required>
</div>
<div class="form-group">
    <label style="color: black;font-size: 0.85rem!important;">PERIHAL SURAT</label>
    <input type="hidden" class="form-control" style="font-size: 0.85rem!important;" name="tahun_surat_eskul" placeholder="PERIHAL SURAT" value="2020">
    <input type="hidden" class="form-control" style="font-size: 0.85rem!important;" name="pengedit_surat_eskul" placeholder="PERIHAL SURAT" value="<?= esc($user_info['id_unik']); ?>">
    <textarea class="form-control" style="font-size: 0.85rem!important;" aria-label="With textarea" name="perihal_surat"> <?= esc($data_surat['perihal_surat_eskul']); ?></textarea>
