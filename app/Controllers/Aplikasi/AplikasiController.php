...
use App\Models\App\Rombel_Model;
use App\Models\App\SuratKeluar_Model;
use App\Models\App\SuratKeputusan_Model;
use App\Models\App\SuratEskul_Model;
...
class AplikasiController extends Controller
{
    ...
    public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
    {
        ...
        $this->DataRombelModel =  new Rombel_Model();
        $this->SuratKeluarModel =  new SuratKeluar_Model();
        $this->SuratKeputusanModel =  new SuratKeputusan_Model();
        $this->SuratEskulModel =  new SuratEskul_Model();
        ...
        // $this->role_id = $session->get('user_role_id');
