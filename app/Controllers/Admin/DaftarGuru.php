...
class DaftarGuru extends AdminController
{
    public function index()
    {
        ...
        $data['view'] = 'view_akun/admin/list_guru';
        echo view('view_akun/template_akun', $data);
    }
    public function get_all_guru()
    {
        $data = $this->GuruModel->get_all_guru();
    ...
    public function view_data()
    {
        ...
        $data['user'] = $this->GuruModel->view_user_by_id($id);
